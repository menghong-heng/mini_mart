...
CREATE TABLE customer_accounts (
  customer_account_id  NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
CREATE TABLE customer_sessions (
  ...
  customer_account_id  NUMBER REFERENCES customer_accounts ON DELETE CASCADE,
...
### 2.3 PL/SQL functions — `queries/customer_auth.sql`
...
| Phase | Scope                                                                   | Est.   |
|-------|-------------------------------------------------------------------------|--------|
| F1    | DB: `customer_accounts`, `customer_sessions`, 4 PL/SQL functions         | 45 min |
